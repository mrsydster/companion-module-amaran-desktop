...
import type { AmaranConfig } from './config'
import { feedbackId, ActionId, deprecatedActionId, deprecatedFeedbackId } from './enums'
import { TimerPhase } from './amaran/amaran-types'

function update2x4x0(
	_context: CompanionUpgradeContext<AmaranConfig>,
	props: CompanionStaticUpgradeProps<AmaranConfig>
): CompanionStaticUpgradeResult<AmaranConfig> {
	const result = {
		updatedConfig: null,
...
export const UpgradeScripts: CompanionStaticUpgradeScript<AmaranConfig>[] = [update2x4x0, update3x4x0, update4xx]
